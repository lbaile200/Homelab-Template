...
------------------------------------------------------------
-- Static, curated spell lists.
--
-- These should contain ONLY spells captured from clean
-- level-70 reference characters.
------------------------------------------------------------

local CLASS_SPELLS = {

    [CLASS_WARRIOR] = {
        -- generated Warrior IDs
      71,                          
      72,                          
      100,                         
      284,                         
...
local function LearnSpellList(player, list)
...
local function GiveShamanTotems(player)
...
local function OnFirstLogin(event, player)
    ...
    local classSpells = CLASS_SPELLS[classId]
    ...
    LearnSpellList(player, classSpells)
    ...
    --------------------------------------------------------
    -- Required physical class items
    --------------------------------------------------------

    GiveShamanTotems(player)


    player:SendBroadcastMessage(
        "|cff00ff00Your level 1-70 class spells have been learned.|r"
    )


    print(string.format(
        "[ClassSpells] Applied curated spell list to %s (class %d)",
        player:GetName(),
        classId
    ))
end
